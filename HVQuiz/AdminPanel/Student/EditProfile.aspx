<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Form.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="HVQuiz.AdminPanel.Student.EditProfile" %>
            ...
            <div class="row ">
                ...
                <div class="col-sm-10 login-box">
                        ...
                        <div class="col-lg-6 col-md-6 log-det">
                            <div class="text-box-cont">
                                <div class="input-group mb-3">
                                    ...
                                    <asp:TextBox ID="txtParticipatename" runat="server" type="text" class="form-control" placeholder="Participate Name" aria-describedby="basic-addon1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvParticipatename" runat="server" ErrorMessage="*" ControlToValidate="txtParticipatename" ForeColor="Red" ></asp:RequiredFieldValidator>
                                </div>
                                 <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><asp:Label runat="server" Font-Size="Smaller">BirthDate</asp:Label></span>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 log-det">
                            <div class="text-box-cont">
                                <div class="input-group mb-3">
                                 ...
                                 <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><asp:Label runat="server" Font-Size="Smaller">Course Name</asp:Label></span>
                                    </div>
                                    <asp:TextBox ID="txtCourseName" runat="server" type="text" class="form-control" aria-describedby="basic-addon1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvstart" runat="server" ErrorMessage="*" ControlToValidate="txtCourseName" ForeColor="Red" ></asp:RequiredFieldValidator>                            
                    ...
                    <div class="row log-det">
                        <div class="col-md-6">
                            <asp:HyperLink ID="btnCancel" runat="server" class="btn btn-round btn-outline-light box-de" Text="Cancel"  style="float:right" NavigateUrl="~/AdminPanel/Student/Participate_Home.aspx"></asp:HyperLink>
                        </div>
                        <div class="col-md-6">
